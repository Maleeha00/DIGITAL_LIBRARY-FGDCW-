...
echo $fileType;
    ...
    // Check if file is a PDF and less than 200MB
    if ($fileType != "pdf" || $_FILES["pdfFile"]["size"] > 200000000) {
        echo "Error: Only PDF files less than 200MB are allowed to upload.";
    } else {
...
<!DOCTYPE html>
    ...
    <!--Bootstrap JS-->
    <script src="https://code.jquery.com/jquery-3.3.1.slim.mim.js"></script>
