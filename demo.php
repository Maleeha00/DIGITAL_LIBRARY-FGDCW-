...
<head>
  ...
  <title>Digital Departments</title>
...
<nav>
  <a href="#home">Home</a>
  <a href="#bs-english">BS English</a>
  <a href="#bs-hpe">BS HPE</a>
  <a href="#bs-it">BS IT</a>
  <a href="#intermediate">Intermediate</a>
</nav>

<!-- Home Section -->
<section id="home">
  <h2 class="section-title">Welcome to Our Digital Campus</h2>
...
<section id="bs-english">
  <h2 class="section-title">BS English Department</h2>
  <div class="info-block reverse show">
    <div class="info-image">
      <img src="magazines.jpg" alt="BS English Image">
    </div>
    <div class="info-text">
...
<!-- BS HPE Section -->
<section id="bs-hpe">
  <h2 class="section-title">BS Health & Physical Education</h2>
  <div class="info-block show">
    ...
    <div class="info-image">
      <img src="sports.jpg" alt="BS HPE Image">
    </div>
  </div>
</section>
...
<!-- BS IT Section -->
<section id="bs-it">
  <h2 class="section-title">BS Information Technology</h2>
  <div class="info-block reverse show">
    <div class="info-image">
      <img src="one.jpg" alt="BS IT Image">
    </div>
    <div class="info-text">
...
<section id="intermediate">
  <h2 class="section-title">Intermediate Students</h2>
  <div class="info-block show">
    <div class="info-text">
    ...
    <div class="info-image">
      <img src="inter.jpg" alt="Intermediate Image">
    </div>
  </div>
</section>
...
<!-- Footer -->
<footer>
  &copy; 2025 Your Unique Digital Campus - All Rights Reserved.
</footer>
